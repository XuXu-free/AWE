...
\sjtusetup{
  ...
  info = {%
    ...
    % 关键词
    %
    zh / keywords        = {电解水制氢；安全学习；扩散模型；控制障碍函数；多槽协调控制},
    en / keywords        = {Water Electrolysis Hydrogen Production; Safe Learning; Diffusion Models; Control Barrier Functions; Multi-Stack Coordinated Control},
    %
    % 姓名
    %
    zh / author          = {须安楠},
