...
% 载入 SJTUThesis 模版
\documentclass[type=bachelor,preset=jwc,text-font=termes,math-font=termes,openany]{sjtuthesis}
% 选项
...
% 正文内容 - 按章节组织
\input{contents/chapter1_introduction}      % 第一章 绪论
\input{contents/chapter2_overview}          % 第二章 AWE系统建模与仿真
\input{contents/chapter3_modeling}          % 第三章 基于扩散模型与CBF的安全学习控制方法
\input{contents/chapter4_conclusion}        % 第四章 结论与展望
