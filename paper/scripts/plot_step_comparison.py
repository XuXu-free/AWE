...
for idx, ax in enumerate(axes.flat):
    ...
    fig.savefig(f'../figures/controller_step_comparison_{label}.png', dpi=600, bbox_inches=bbox_inches, facecolor='white')
    print(f'Saved: ../figures/controller_step_comparison_{label}.png')
plt.close()
