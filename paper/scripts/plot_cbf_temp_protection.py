...
fig.subplots_adjust(hspace=0.32, wspace=0.28, left=0.08, right=0.97, top=0.90, bottom=0.12)
...
for idx, ax in enumerate(axes.flat):
    ...
    fig.savefig(f'../figures/cbf_temp_protection_{label}.png', dpi=600, bbox_inches=bbox_inches, facecolor='white')
    print(f'Saved: ../figures/cbf_temp_protection_{label}.png')
plt.close()
